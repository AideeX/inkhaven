...
import { sendPasswordResetEmail } from '@/app/lib/firebase/auth/auth'; 
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-8">
      <div className="w-full max-w-md bg-light-secondaryBg p-8 rounded-lg shadow-lg">
        ...
        <h4 className={` ${literata.className} text-2xl font-bold mb-6 text-light-heading  text-center`}>Forgot Password?</h4>
