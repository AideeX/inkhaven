...
const SignInForm = () => {
    ...
    return (
                <div className="relative flex flex-col md:flex-row justify-center items-center h-auto md:min-h-screen w-2/3 mx-auto bg-[url('/purple-bg.PNG')] bg-cover bg-center rounded-lg shadow-2xl">
        
          <div className="hidden md:flex flex-col w-1/2 justify-center items-center text-center p-8">
          <Link href='/' className="absolute top-4 left-56 md:block hidden">
          ...
          <div className="flex flex-col w-full h-full md:w-1/2 p-8 bg-light-secondaryBg rounded-lg md:rounded-r-lg shadow-lg md:m-0">
