    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center min-h-screen w-2/3 mx-auto bg-[url('/purple-bg.PNG')] bg-cover bg-center rounded-lg shadow-2xl">
            ...
            <div className="hidden md:flex flex-col w-1/2 justify-center items-center text-center p-8 ">
                <h2 className={`text-3xl font-bold text-dark-heading mb-6 ${literata.className}`}>Join InkHaven</h2>
            ...
            <div className="flex flex-col w-full h-full md:w-1/2 p-8 bg-light-secondaryBg rounded-lg md:rounded-r-lg shadow-lg">
                <h1 className={`text-3xl text-center font-bold mb-6 text-light-heading ${literata.className}`}>Welcome Back to InkHaven</h1>
                ...
                <div className="space-y-2">
                    <button onClick={handleGoogleSignIn} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-light-heading bg-light-primary hover:bg-light-accentLight focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-accentMedium">
                        <FaGoogle className="mr-2 text-red-600" /> Sign In with Google
                    </button>
                    <button onClick={handleFacebookSignIn} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-light-heading bg-light-primary hover:bg-light-accentLight focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-accentMedium">
                        <FaFacebook className="mr-2 text-blue-600" /> Sign In with Facebook
                    </button>
                    <button onClick={handleTwitterSignIn} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-light-heading bg-light-primary hover:bg-light-accentLight focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-accentMedium">
