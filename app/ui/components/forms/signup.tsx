...
const SignUpForm = () => {
    ...
    return (
        <div className="relative flex flex-col md:flex-row justify-center items-center min-h-screen w-full max-w-screen-md mx-auto bg-none md:bg-[url('/purple-bg2.PNG')] bg-cover bg-center rounded-lg shadow-2xl">
            <div className="flex flex-col w-full md:w-1/2 p-6 md:p-8 bg-light-secondaryBg rounded-lg md:rounded-l-lg shadow-lg">
                <div className="w-full h-full">
                    <Link href='/' className="hidden md:block absolute right-4">
                        <Image src="/darkmode.svg" alt="InkHaven" width={150} height={50} />
                    </Link>
                    <h1 className={`text-2xl md:text-3xl font-bold text-center mb-6 ${literata.className}`}>
            ...
            <div className="hidden md:flex flex-col w-1/2 justify-center items-center mb-16 md:mb-64 text-center p-8">
                <h2 className={`text-2xl md:text-3xl font-bold text-white mb-6 ${literata.className}`}>
